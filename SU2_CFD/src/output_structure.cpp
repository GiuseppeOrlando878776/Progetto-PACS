      ...
      if (  (!fem && ((write_heads) && !(!DualTime_Iteration && Unsteady))) ||
        ...
        switch (config[val_iZone]->GetKind_Solver()) {
          ...
          case REACTIVE_RANS:
            ...
            std::cout<<"Maximum Omega " << solver_container[val_iZone][FinestMesh][REACTIVE_SOL]->GetOmega_Max() <<
                       ", maximum Strain Rate "<<solver_container[val_iZone][FinestMesh][REACTIVE_SOL]->GetStrainMag_Max()<< "."<<std::endl;
            ...
            std::cout << "     Res[Rho]" << "     Res[kine]" << "     Res[omega]" << std::endl;
    ...
    if(DualTime_Iteration || !Unsteady) {
        ...
        case REACTIVE_RANS:
          ...
          if(DualTime_Iteration || !Unsteady) {
            ...
            std::cout<<std::log10(residual_turbulent[0]);
            std::cout.width(15);
            std::cout<<std::log10(residual_turbulent[1]); break;
          }
